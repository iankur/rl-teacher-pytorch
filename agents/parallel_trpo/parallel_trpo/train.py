...
def train_parallel_trpo(
    ...
    while run_indefinitely or time() < start_time + runtime:
        ...
        if summary_writer:
            ...
            summary_writer.add_scalar("parallel_trpo/mean_reward", mean_reward, iteration)
            summary_writer.add_scalar("parallel_trpo/elapsed_seconds", total_elapsed_seconds, iteration)
            summary_writer.add_scalar("parallel_trpo/frames_gathered_per_second", frames_gathered_per_second, iteration)
